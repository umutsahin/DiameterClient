...
public abstract class DiameterChargingFlow extends DiameterFlow {
    ...
    public DiameterFlow restart() {
        return new DiameterIMSMOC(msisdn, ratingGroup, messageCount);
    }
    ...
    public static DiameterFlow newInstance(String flowName, String msisdn, int ratingGroup, int messageCount) {
        return switch (flowName) {
            case "ims-moc" -> new DiameterIMSMOC(msisdn, ratingGroup, messageCount);
            case "ims-mtc" -> new DiameterIMSMTC(msisdn, ratingGroup, messageCount);
            case "ps" -> new DiameterPS(msisdn, ratingGroup, messageCount);
